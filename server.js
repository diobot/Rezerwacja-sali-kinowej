...
router.get('/kino.json', function(req, res){ 
	res.sendFile(path.join(__dirname + '/home/json/kino.json'));
});
router.get('/reservation.json', function(req, res){ 
	res.sendFile(path.join(__dirname + '/home/json/reservation.json'));
});
router.get('/register.json', function(req, res){ 
	res.sendFile(path.join(__dirname + '/home/json/register.json'));
});